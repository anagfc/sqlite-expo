...
import Container from './src/components/Container'; // Importação do Container criado dentro dos componentes

import Header from './src/components/Header'; // Importação do Header criado dentro dos componentes

import Body from './src/components/Body'; // Importação do Body criado dentro dos componentes
